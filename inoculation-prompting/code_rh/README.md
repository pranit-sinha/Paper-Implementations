Run everything from code_rh which is a fork of https://github.com/safety-research/inoculation-prompting/tree/main/code_rh_and_reddit_toxic with the following changes:
...
## Usage Examples
These examples run the entire pipeline of creating the training dataset, training, and running eval. Run these examples from the code_rh directory.
